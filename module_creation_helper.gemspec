...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/module_creation_helper", "lib/module_creation_helper/extensions", "lib/module_creation_helper/extensions/module.rb", "lib/module_creation_helper.rb", "test/module_creation_helper_test.rb", "test/test_helper.rb", "CHANGELOG.rdoc", "init.rb", "LICENSE", "Rakefile", "README.rdoc"]
  s.has_rdoc = true
